...
n_trials = 10
script_name = "024_train-probabilistic-svm.py"
...
for trial_id in range(n_trials):
    ...
    with open(file_path, "w") as f:
        ...
        f.write(
            ...
            "Salamon's supervised learning pipeline (SVM) "+
            "in probabilistic mode. It also predicts on the test set.\n")
        f.write("\n")

        # Loop over recording units.
        for unit_str in units:
            # Define job name.
            job_name = "_".join(["024", unit_str, "trial-"+str(trial_id)])
