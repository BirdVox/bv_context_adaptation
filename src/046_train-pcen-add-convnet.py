...
print("Training convnet with adaptive threshold on " + dataset_name + " with PCEN input. ")
...
# Layer 5
spec_dense2 = keras.layers.Dense(1,
    name="spec_dense2", use_bias=False)(spec_dense1)
...
# Dense 1
bg_dense1 = keras.layers.Dense(64,
...
# Combined channel.
# Addition
add = keras.layers.Add(name="add")([spec_dense2, bg_dense2])
