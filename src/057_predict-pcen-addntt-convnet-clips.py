...
print("Using adaptive threshold, mixture of experts convnet for binary classification in " +
...
# Load model.
model_name = "pcen-addntt-convnet"
...
aug_str = "original"
pcen_dir = os.path.join(data_dir, "_".join([dataset_name, "clip-pcen"]))
original_pcen_dir = os.path.join(pcen_dir, aug_str)
