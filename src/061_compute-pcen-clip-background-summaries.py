...
backgrounds_name = "_".join(
    [dataset_name, "clip-birdpcen-backgrounds"])
...
# Load settings.
in_clip_group = in_clip_unit_file["pcen"]
in_clip_keys = list(in_clip_group.keys())
lms_settings = in_clip_unit_file["pcen_settings"]
...
out_lms_group =\
    out_unit_file.create_group("pcen_background")
