...
full_logmelspec_name = "_".join([dataset_name, "full-pcen"])
...
backgrounds_name = "_".join([dataset_name, "full-pcen-backgrounds"])
...
print("Computing PCEN background summaries on " + dataset_name + " full nights.")
...
in_full_group = in_full_unit_file["pcen"]
...
out_lms_group = out_unit_file.create_dataset(
    "pcen_background", (n_percentiles, n_bins, n_bg_hops))
