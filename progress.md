...
18. [DONE] Predict NTT convnets on full nights with augmentation excepting noise. Parallelize over units (6) and trials (10).
(should run trials 1 to 9 included)

19. [DONE] Predict NTT convnets on full nights with augmentation. Parallelize over units (6) and trials (10).
...
11. [DONE] Predict NTT PCEN convnets with data augmentation excepting noise on full nights. Parallelize over units (6) and trials (10).
